...
class Ovni extends THREE.Object3D {
    ...
    createBody() {
        ...
        this.bodyMaterials.push(this.bodyMaterials[1]);
        this.body.add(new THREE.Mesh(geometry, this.bodyMaterials[1]));
        this.add(this.body);
    }
    ...
    createCockPit() {
        ...
        this.cockPitMaterials.push(this.cockPitMaterials[1]);
        this.cockPit.add(new THREE.Mesh(new THREE.SphereGeometry(cockPitXYZ/2), this.cockPitMaterials[1]));
    ...
    createBigLight() {
        ...
        this.bigLightMaterials.push(this.bigLightMaterials[1]);
        this.bigLight.add(new THREE.Mesh(new THREE.CylinderGeometry(bigLightXZ/2, bigLightXZ/2, bigLightY, 40), this.bigLightMaterials[1]));
    ...
    createSmallLights() {
        ...
        this.smallLightsMaterials.push(this.smallLightsMaterials[1]);
        var leftLight = new THREE.Mesh(geometry, this.smallLightsMaterials[1]);
